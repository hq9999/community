        ...
        <el-tab-pane label="水站" name="first">
          ...
          <el-dialog title="添加" :visible.sync="dialogFormVisible">
            <el-form :model="form" :rules="rules">
              <el-form-item label="水站名称" :label-width="formLabelWidth" prop="name">
                <el-input v-model="form.name" autocomplete="off" placeholder="水站名称"></el-input>
              </el-form-item>
              <el-form-item label="图片地址" :label-width="formLabelWidth" prop="img">
                <el-input v-model="form.img" autocomplete="off" placeholder="图片地址"></el-input>
              </el-form-item>
              ...
              <el-form-item label="水站评分" :label-width="formLabelWidth" prop="score">
                <el-input
              ...
              <el-form-item label="地址" :label-width="formLabelWidth" prop="address">
                <el-input v-model="form.address" placeholder="地址" autocomplete="off"></el-input>
              </el-form-item>
              <el-form-item label="距离" :label-width="formLabelWidth" prop="len">
                <el-input
                  v-model.number="form.len"
                  placeholder="eg:2.4km"
                  autocomplete="off"
                  type="number"
                ></el-input>
              </el-form-item>
  ...
  data() {
    ...
    return {
      rules: {
        ...
        count: [{ required: true, validator: cNull, trigger: "blur" }],
